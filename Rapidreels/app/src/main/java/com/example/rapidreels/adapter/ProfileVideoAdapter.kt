...
import com.example.rapidreels.SingleVideoPlayerActivity
import com.example.rapidreels.databinding.ProflieVideoItemRowBinding
    ...
    : FirestoreRecyclerAdapter<VideoModel, ProfileVideoAdapter.VideoViewHolder>(options)
{
    ...
    inner class VideoViewHolder( val binding: ProflieVideoItemRowBinding): RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VideoViewHolder {
        val binding = ProflieVideoItemRowBinding.inflate(LayoutInflater.from(parent.context),parent,false)
